...
the commands directly.  It also contains an instance of the
...
:cpp:class:`Pointers`, is created and then its ``command()`` member
function executed and then the class instance is deleted again.
